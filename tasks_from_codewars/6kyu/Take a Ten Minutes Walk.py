...
"""
# my code
# used  x = walk.count('e') # подсчет кол-ва одинаковых элементов в списке


def is_valid_walk(walk):
    if walk.count('e') - walk.count('w') == 0 and walk.count('n') - walk.count('s') == 0 and len(walk) == 10:
        return True
    return False
